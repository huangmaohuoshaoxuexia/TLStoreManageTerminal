...
public class PickDetailListActivity extends BaseActivity{
    ...
    protected int getLayoutId() {
        return R.layout.pick_detail_list_layout;
    }
    ...
    public void initViews() {
        super.initViews();
        mRecyclerView = findViewById(R.id.pick_detail_list_recyview);
    }
    ...
    class RecyAdapter extends RecyclerView.Adapter<RecyAdapter.MyViewHolder> {
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            MyViewHolder holder = new MyViewHolder(LayoutInflater.from(
                    PickDetailListActivity.this).inflate(R.layout.pick_detail_list_item, parent,
                    false));
            return holder;
        }
        ...
        public void onBindViewHolder(MyViewHolder holder, final int position) {
            holder.mContentLayout.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    startActivity(PickDetailActivity.class,null);
                }
            });
        }
