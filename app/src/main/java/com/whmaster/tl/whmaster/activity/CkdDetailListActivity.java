...
public class CkdDetailListActivity extends BaseActivity{

    private XRecyclerView mRecyclerView;
    private RecyAdapter mAdapter;
    @Override
    protected int getLayoutId() {
        return R.layout.ckd_detail_list_layout;
        //
    }
    ...
    public void initViews() {
        super.initViews();
        mRecyclerView = findViewById(R.id.ckd_detail_rcview);
    }
    ...
    class RecyAdapter extends RecyclerView.Adapter<RecyAdapter.MyViewHolder> {
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            MyViewHolder holder = new MyViewHolder(LayoutInflater.from(
                    CkdDetailListActivity.this).inflate(R.layout.ckd_detail_list_item_layout, parent,
                    false));
            return holder;
        }
        @Override
