...
public class GenerateCkdActivity extends BaseActivity{
    ...
    protected int getLayoutId() {
        return R.layout.generate_ckd_layout;
    }
    ...
    public void initViews() {
        super.initViews();
        mRecyclerView = findViewById(R.id.generate_ckd_recyview);
    }
    ...
    class RecyAdapter extends RecyclerView.Adapter<RecyAdapter.MyViewHolder> {
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            MyViewHolder holder = new MyViewHolder(LayoutInflater.from(
                    GenerateCkdActivity.this).inflate(R.layout.generate_ckd_item_layout, parent,
                    false));
            return holder;
        }
        ...
        public void onBindViewHolder(MyViewHolder holder, final int position) {
            holder.mContentLayout.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    startActivity(CkdDetailListActivity.class,null);
                }
            });
        }
